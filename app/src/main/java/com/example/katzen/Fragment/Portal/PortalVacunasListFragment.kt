...
import com.example.katzen.Adapter.Portal.PortalVacunaAdapter
...
class PortalVacunasListFragment : Fragment() {
    private var _binding: PortalListSectionFragmentBinding? = null
    private val binding get() = _binding!!
    private val adapter = PortalVacunaAdapter()
    ...
    override fun onCreateView(
        ...
        PortalExpedienteUi.applySectionHeader(binding, PortalExpedienteUi.Section.VACUNAS)
        binding.tvSectionTitle.text = getString(R.string.portal_section_vacunas)
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            val items = withContext(Dispatchers.IO) {
                runCatching { FirebasePortalUtil.obtenerVacunasPorMascota(mascotaId) }
                    ...
                    .sortedByDescending { it.fechaRegistro.ifBlank { it.fecha } }
            }
            ...
            PortalExpedienteUi.setEmptyState(
                ...
                isEmpty,
                getString(R.string.portal_empty_vacunas),
    ...
    companion object {
        ...
        fun newInstance(mascotaId: String, mascotaNombre: String): PortalVacunasListFragment {
            return PortalVacunasListFragment().apply {
