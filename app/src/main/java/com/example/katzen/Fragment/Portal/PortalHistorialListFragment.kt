...
class PortalHistorialListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.tvSectionTitle.text = getString(R.string.portal_section_historial)
    ...
    companion object {
        ...
        fun newInstance(mascotaId: String, mascotaNombre: String): PortalHistorialListFragment {
            return PortalHistorialListFragment().apply {
