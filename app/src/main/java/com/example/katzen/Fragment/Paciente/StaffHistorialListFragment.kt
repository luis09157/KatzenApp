...
import com.example.katzen.Adapter.Portal.PortalHistorialAdapter
...
/**
 * Historial clínico staff (solo lectura). Usa el mismo mapeo RTDB que el portal web.
 */
class StaffHistorialListFragment : Fragment() {
    private var _binding: PortalListSectionFragmentBinding? = null
    private val binding get() = _binding!!
    private val adapter = PortalHistorialAdapter()
    ...
    override fun onCreateView(
        ...
        PortalExpedienteUi.applySectionHeader(binding, PortalExpedienteUi.Section.HISTORIAL)
        binding.tvSectionTitle.text = getString(R.string.submenu_historial_clinico)
    ...
    private fun loadData() {
        ...
        viewLifecycleOwner.lifecycleScope.launch {
            ...
            PortalExpedienteUi.setEmptyState(
                ...
                isEmpty,
                getString(R.string.portal_empty_historial),
    ...
    companion object {
        ...
        fun newInstance(mascotaId: String, mascotaNombre: String): StaffHistorialListFragment {
            return StaffHistorialListFragment().apply {
